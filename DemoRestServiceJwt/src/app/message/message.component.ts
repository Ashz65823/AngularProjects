...
export class MessageComponent implements OnInit {
  ...
  loadMessage() {
    ...
    this.service.getMessages().subscribe(success => this.messages = success,
      // error => this.outputMessage + this.outputMessage = error.message+error.status +"\n Please Try again.. There is an Exception"//or error => this.outputMessage = error.message+error.status
      error => {
        this.outputMessage = error.status + "Exception" + error.message
      }
